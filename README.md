# Description
This is a C# 🟪 console application to integrate the console to azure app configuration ⚙️ in order to management the value object and feature flags 🚩. This is in order to study and practice for az204 certification exam 🤓📚🎓
...
# Direct command with dotnet cli
